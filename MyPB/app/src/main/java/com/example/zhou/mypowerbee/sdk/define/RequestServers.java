...
import com.example.zhou.mypowerbee.sdk.dto.UserDTO;
...
public interface RequestServers {
    ...
    @POST("user")
    Observable<UserInfoDTO> register(@Body UserInfoDTO.UserDTO userDTO,@Header("vid") String vid,@Header("code") String code);
